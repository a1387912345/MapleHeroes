...
//                case JOB:
  ...
  public static byte[] getGachaponMega(String name, String message, Item item, byte rareness, boolean dragon, String gacha) {
    ...
    public static byte[] getCard(int cardid, int cardCount) {
        ...
        mplew.writeShort(SendPacketOpcode.MONSTER_BOOK_SET_CARD.getValue());
    ...
    public static byte[] changeCardSet(int cardid) {
        ...
        mplew.writeShort(SendPacketOpcode.MONSTER_BOOK_SET_COVER.getValue());
        mplew.writeInt(cardid);
    ...
    public static byte[] fairyPendantMessage(int termStart, int incExpR) {
        ...
        mplew.writeShort(SendPacketOpcode.BONUS_EXP.getValue());
        mplew.writeInt(17);
        mplew.writeInt(0);
    ...
    public static byte[] gmBoard(int increnement, String url) { //Test if it DOES work with the open_UI packet.
        ...
        mplew.write(SendPacketOpcode.GM_STORY_BOARD.getValue());//was 0x1D
    ...
    public static byte[] updateJaguar(MapleCharacter from) {
        ...
        mplew.writeShort(SendPacketOpcode.WILD_HUNTER_INFO.getValue());
...
//    }
    ...
    public static class FamilyPacket {
        ...
        public static byte[] sendFamilyJoinResponse(boolean accepted, String added) {
            ...
            mplew.writeShort(SendPacketOpcode.FAMILY_INVITE_RESPONSE.getValue());
...
//        mplew.writeZeroBytes(6);
    ...
    public static class PartyPacket {
        ...
        public static void addPartyStatus(int forchannel, MapleParty party, MaplePacketLittleEndianWriter mplew, boolean leaving) {
            addPartyStatus(forchannel, party, mplew, leaving, false);
        }

        public static void addPartyStatus(int forchannel, MapleParty party, MaplePacketLittleEndianWriter mplew, boolean leaving, boolean exped) {

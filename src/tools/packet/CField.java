...
//            mplew.write(0);//removed 143 or other0
    ...
    */
    ...
    public static byte[] spawnClockMist(final MapleMist clock) {
        ...
        packet.writeShort(0x07);//clock.getSkillDelay());
        ...
        packet.writeInt(0);
        packet.writeInt(clock.getClockType() == 1 ? 15 : clock.getClockType() == 2 ? -15 : 0);
        packet.writeInt(0x78);
        ...
        if(unk == 1){
            ...
            mplew.writeInt(1);
            mplew.writeInt(1);
            mplew.writeInt(900); //POSX
            mplew.writeInt(-1347); //POSY
            mplew.writeInt(25);
            mplew.writeInt(3);
            mplew.writeInt(0);
            mplew.writeInt(25);
...
//                mplew.writeInt(Integer.MAX_VALUE);
    ...
    public static class EffectPacket {
        ...
        public static byte[] ShowWZEffect(String data) {
            ...
            mplew.writeShort(SendPacketOpcode.SHOW_SPECIAL_EFFECT.getValue());
            mplew.writeLong(24); // This value changes between patches.
            mplew.writeShort(0);
            mplew.writeMapleAsciiString(data);

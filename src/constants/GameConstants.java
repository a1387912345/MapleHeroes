...
public class GameConstants {
    ...
    public static final int JAIL = 180000004, MAX_BUFFSTAT = 16;
    ...
    public static final int getLinkedAttackSkill(final int id) {
        switch (id) {
            ...
            case 31001008:
                return 31000004;
            case 27120211:
                return 27121201; //ëª¨ë‹� ìŠ¤íƒ€í�´
            case 61001004:
            case 61001005:
            case 61110212:
            case 61120219:
                return 61001000; //ë“œëž˜ê³¤ìŠ¬ëž˜ì‹œ
            case 61110211:
            case 61120007:
            case 61121217:
                return 61101002; //ìœŒì˜¤ë¸Œì†Œë“œ
            case 61111215:
                return 61001101; // í”Œë ˆìž„ ìƒ·
            case 61111217:
                return 61101101; // í”¼ì–´ìŠ¤ ëŸ¬ì‰¬
            case 61111216:
                return 61101100; // ìž„íŒ©íŠ¸ ì›¨ì�´ë¸Œ
            case 61111219:
                return 61111101; // ì²´ì�¸í’€ë§�
            case 61111113:
            case 61111218:
                return 61111100; //ìœ™ë¹„íŠ¸ - ì»¤ë§¨ë“œ
            case 61121201:
                return 61121100; //ê¸°ê°€ìŠ¬ëž˜ì…”
            case 61121203:
                return 61121102; //ë¸”ë£¨ìŠ¤íŠ¸ë¦­
            case 61110009:
                return 61111003; //ë¦¬ê²Œì�¸ ìŠ¤íŠ¸ë �ìŠ¤
            /*case 61121217:
             return 61120007; //ì–´ë“œë°´ìŠ¤ë“œ ì›”ì˜¤ë¸Œì†Œë“œ*/
            case 61121116:
                return 61121104; //ì†Œë“œìŠ¤íŠ¸ë�¼ì�´í�¬ - í�­íŒ”
            case 61121223:
                return 61121221; //ì†Œë“œ ìŠ¤íŠ¸ë�¼ì�´í�¬ - í�­íŒ”
            case 61121221:
                return 61121104; // ì†Œë“œ ìŠ¤íŠ¸ë�¼ì�´í�¬
            case 65101006:
                return 65101106;
            case 65121007:
            case 65121008:
                return 65121101;
            case 61111220:
                return 61121105; // ì�¸í�¼ë„� ë¸Œë ˆìŠ¤
            //case 61120018:
            //      return 61121105;
            //ì¹´ì�´ì €ë��
            case 65111007: //ì†Œìš¸ ì‹œì»¤
                return 65111100;
            case 4100012: //ë§ˆí�¬ ì˜¤ë¸Œ ì–´ìŒ”ì‹ 
                return 4100011;
            case 24121010:
                return 24121003;
            case 24111008:
            ...
            case 25120003:
                return 25121000;
            case 95001000:
                return 3111013; // ì• ë¡œìš° í”Œëž˜í„°
            case 4210014: //ë©”ì†Œ ì�µìŠ¤í”Œë¡œì ¼
                return 4211006;
            case 101000102: //ì–´ë“œë°´ìŠ¤ë“œ íŒŒì›Œ ìŠ¤í…€í”„(ì¶©ê²©íŒŒ) 
                return 101000101;
            // ë‚˜ì›Œ ì‹œìž‘
            case 14101021:
                return 14101020; // íŠ¸ë¦¬í”Œ ìŠ¤ë¡œìš°
            case 14111021:
                return 14111020; // ì¿¼ë“œëŸ¬í”Œ ìŠ¤ë¡œìš°
            case 14111023:
                return 14111022; // ìŠ¤íƒ€ë�”ìŠ¤íŠ¸
            case 14121002:
                return 14121001; // í€¸í„°í”Œ ìŠ¤ë¡œìš°
            // ë‚˜ì›Œ ë��
            //í”Œìœ„ ì‹œìž‘
            case 12120011:
                return 12121001;
...
//        System.out.println(getSkillBook(skillid / 10000));
    ...
    public static boolean isFastAttackSkill(int skillId) {
        switch(skillId) {
            ...
            case 36120045:
                return true;
            default:
                System.out.println("Fast Attack Skill Detected!! if not a hack add:");
                System.out.println("        " + skillId);
                System.out.println("to isFastAttackSkill ");
                return false;
        }
    }
    ...
    private static final int[] wheelRewardsB = {2512139, 2512159, 2512179, 2512199, 2512219, 2512239, 2512249, 2000000, 2000001, 2000002, 2000003, 2000007, 2000008, 2000009, 2000010, 2002000, 2002001, 2002002, 2000018, 2000019, 2020012, 2020014, 2001003, 2001515, 2001516, 2001517, 2001518, 2001519, 2001520, 2001521, 2001522, 2001523, 2001524, 2001525, 2003503, 2003504, 2003505, 2003506, 2003507, 2003508, 2004003, 2004023, 2004043, 2004063, 2030000, 2030001, 2030002, 2030003, 2030004, 2030005, 2030006, 4000014, 4000030, 4000073, 4000082, 4000085, 4000103, 4000118, 4000235, 4000296, 4000327, 4000352, 4000445, 4000446, 4000600};
   ...
   /* public static List<Integer> getSealedBoxItems(int itemId) {
    ...
    public static final int BEAST_TEAMER_INFO = 59300;

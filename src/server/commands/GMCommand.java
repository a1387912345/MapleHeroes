    ...
    public static class gmtext extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (splitted[1].equalsIgnoreCase("normal")) {
                ...
                c.getPlayer().dropMessage(6, "Wrong syntax: use !gmtext normal/orange/pink/purple/green/blue/red/whitebg/lightinggreen/yellow/spouse");
                return 1;
            }
            try {

  ...
  /*  public static class Vac extends CommandExecute {
    ...
    public static class maxstats extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().updateSingleStat(MapleStat.HP, 50000);
            c.getPlayer().updateSingleStat(MapleStat.MP, 50000);
            return 1;
        }
    }
    ...
    public static class eyesperson extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            MapleCharacter victim = c.getChannelServer().getPlayerStorage().getCharacterByName(splitted[1]);
            if (splitted.length < 3) {
                c.getPlayer().dropMessage(5, "!eyesperson <player> <faceID>");
                return 0;
            }
    ...
    public static class hairperson extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            MapleCharacter victim = c.getChannelServer().getPlayerStorage().getCharacterByName(splitted[1]);
            if (splitted.length < 3) {
                c.getPlayer().dropMessage(5, "!eyesperson <player> <hairID>");
                return 0;
            }

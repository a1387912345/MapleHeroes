...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    SEAL(0x80000, 1),
    DARKNESS(0x100000, 1),
    COMBO(0x400000, 3), // Last updated: v171
    ...
    SHADOWPARTNER(0x40000, 3), // Last updated: v171
 ...
 //   MAGIC_RESISTANCE(0x40000, 3),
    ...
    DAMAGE_R(0x200, 6),
    MDEF_BOOST(0x2000, 6),//Placeholder
    WDEF_BOOST(0x4000, 6), 
 ...
 // MONSTER_RIDING(0x10000000, 8),
    ...
    MDEF_BOOST2(0x2000, 6, true),
  //  NewParty_stance(0x4000, 4),
    HAYATO1(0x2, 12),
    HAYATO2(0x4, 12),
    SHIKIGAMI(0x10, 12),
    HAYATO3(0x20, 12),

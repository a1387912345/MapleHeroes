...
public class UseCarvedSealHandler extends MaplePacketHandler {
	...
	public void handlePacket(MaplePacketReader inPacket, MapleClient c, MapleCharacter chr) {
		//inPacket: [90 64 C8 14] [04 00] [0F 00]
        c.getCharacter().updateTick(inPacket.readInt());
        final short seal = inPacket.readShort();
        final short equip = inPacket.readShort();

...
public class PartyRequestHandler extends MaplePacketHandler {
	...
	public void handlePacket(final MaplePacketReader lea, final MapleClient c, final MapleCharacter chr) {
        ...
        if ((action == 50)) {
            ...
            MapleCharacter chr = c.getPlayer().getMap().getCharacterById(inPacket.readInt());
        ...
        if ((c.getCharacter().getParty() == null) && (c.getCharacter().getQuestNoAdd(MapleQuest.getInstance(122901)) == null)) {
            ...
            if (party != null) {
                ...
                if (action == 38) { // v171 = 38; This action is when a player accepts the party invitation.
                    ...
                    if (partyRequester != null) {
                    	//partyRequester.getClient().sendPacket(CWvsContext.PartyPacket.partyStatusMessage(23, c.getPlayer().getName()));
                    }
                }
            } else {

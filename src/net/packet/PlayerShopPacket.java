...
public class PlayerShopPacket {
    ...
    public static byte[] sendTitleBox(int mode) {
        MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.SEND_TITLE_BOX);
		mplew.write(mode);
        if ((mode == 8) || (mode == 16)) {
            mplew.writeInt(0);
            mplew.write(0);
    ...
    public static byte[] requestShopPic(final int oid) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.SEND_TITLE_BOX);
		mplew.write(17);
        mplew.writeInt(oid);
        mplew.writeShort(0);
        mplew.writeLong(0L);
    ...
    public static final byte[] addCharBox(final MapleCharacter c, final int type) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.UPDATE_CHAR_BOX);
    ...
    public static final byte[] getPlayerStore(final MapleCharacter chr, final boolean firstTime) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.PLAYER_INTERACTION);
    ...
    public static final byte[] shopErrorMessage(final int error, final int type) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.PLAYER_INTERACTION);
		mplew.write(GameConstants.GMS ? 28 : 10);//was18
        mplew.write(type);
        mplew.write(error);
    ...
    public static final byte[] spawnHiredMerchant(final HiredMerchant hm) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.SPAWN_HIRED_MERCHANT);
...
//        System.err.println(hm.getItemId());
    ...
    public static final byte[] destroyHiredMerchant(final int id) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.DESTROY_HIRED_MERCHANT);
		mplew.writeInt(id);
...
//        mplew.write(19);//was10
    ...
    public static final byte[] updateHiredMerchant(final HiredMerchant shop) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.UPDATE_HIRED_MERCHANT);
    ...
    public static final byte[] merchItem_Message(final int op) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.MERCH_ITEM_MSG);
		mplew.write(op);
    ...
    public static final byte[] merchItemStore(final byte op, final int days, final int fees) {
        final MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.MERCH_ITEM_STORE);
    ...
    public static byte[] getMiniGame(MapleClient c, MapleMiniGame minigame) {
        ...
        mplew.writeShort(minigame.getVisitorSlot(c.getCharacter()));
    ...
    public static void addGameInfo(MaplePacketWriter mplew, MapleCharacter chr, MapleMiniGame game) {

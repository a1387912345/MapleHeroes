...
public class EvolvingPacket {
    ...
    public static byte[] partyCoreInfo(int[] core) {
        MaplePacketWriter mplew = new MaplePacketWriter(SendPacketOpcode.EVOLVING_ACTION);
    ...
    public static void EvolvingWarpToMapInfo(MaplePacketWriter mplew, MapleCharacter player, MapleMap map, int sp) {

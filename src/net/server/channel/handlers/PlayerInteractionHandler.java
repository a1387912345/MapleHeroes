...
import net.channel.handler.PlayerInteractionHandler.Interaction;
            ...
            case CREATE: {
                ...
                if (createType == 4) { // trade//was 3
                    ...
                    if (createType == 1 || createType == 2) {
                        ...
                        Item shop = c.getPlayer().getInventory(MapleInventoryType.CASH).getItem((byte) lea.readShort());
                        if (shop == null || shop.getQuantity() <= 0 || shop.getItemId() != lea.readInt() || c.getPlayer().getMapId() < 910000001 || c.getPlayer().getMapId() > 910000022) {
                            return;
                        }
                        if (createType == 3) {

...
public class UseNebuliteFusionHandler extends AbstractMaplePacketHandler {
	...
	public void handlePacket(LittleEndianAccessor lea, MapleClient c, MapleCharacter chr) {
        ...
        final Item nebulite1 = c.getPlayer().getInventory(MapleInventoryType.SETUP).getItem((byte) lea.readShort());
        final int nebuliteId2 = lea.readInt();
        final Item nebulite2 = c.getPlayer().getInventory(MapleInventoryType.SETUP).getItem((byte) lea.readShort());

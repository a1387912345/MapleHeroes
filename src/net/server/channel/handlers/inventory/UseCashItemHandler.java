	...
	public void handlePacket(LittleEndianAccessor lea, MapleClient c, MapleCharacter chr) {
        ...
        switch (itemId) {
            ...
            case 5500000: { // Magic Hourglass 1 day
                final Item item = c.getPlayer().getInventory(MapleInventoryType.EQUIPPED).getItem(lea.readShort());
            ...
            case 5534000: { //tims lab
                final Item item = c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem((byte) lea.readInt());
                if (item != null) {
            ...
            case 5750000: { //alien cube
                if (c.getPlayer().getLevel() < 10) {
                    ...
                    final Item item = c.getPlayer().getInventory(MapleInventoryType.SETUP).getItem((byte) lea.readInt());
            ...
            case 5521000: { // Karma
                ...
                final Item item = c.getPlayer().getInventory(type).getItem((byte) lea.readInt());
            ...
            case 5570000: { // Vicious Hammer
                ...
                final Equip item = (Equip) c.getPlayer().getInventory(MapleInventoryType.EQUIP).getItem((byte) lea.readInt());
            ...
            case 5610000: { // Vega 30
                ...
                used = InventoryHandler.UseUpgradeScroll(src, dst, (short) 2, c, c.getPlayer(), itemId, false); //cannot use ws with vega but we dont care
                cc = used;
                break;
            }
            ...
            case 5370000: { // Chalkboard
                ...
                c.getPlayer().setChalkboard(lea.readMapleAsciiString());
                break;
            }
            ...
            default:
                ...
                if (itemId / 10000 == 512) {
                    ...
                    if (InventoryHandler.UseSkillBook(slot, itemId, c, c.getPlayer())) {
                        c.getPlayer().gainSP(1);
                    } //this should handle removing
                } else if (itemId / 10000 == 553) {
                    InventoryHandler.UseRewardItem(slot, itemId, false, c, c.getPlayer());// this too

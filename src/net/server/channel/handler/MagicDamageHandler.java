...
public class MagicDamageHandler extends MaplePacketHandler {
	...
	public void handlePacket(final MaplePacketReader lea, final MapleClient c, MapleCharacter chr) {
     ...
     /*   if (skill.getId() >= 27100000 && skill.getId() < 27120400 && attack.targets > 0 && chr.getLuminousState() < 20040000) {
            ...
            c.sendPacket(JobPacket.LuminousPacket.giveLuminousState(GameConstants.getLuminousSkillMode(skill.getId()), chr.getLightGauge(), chr.getDarkGauge(), 10000));

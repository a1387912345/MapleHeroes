...
public class MonsterCarnivalHandler {
    ...
    public static final void MonsterCarnival(final MaplePacketReader inPacket, final MapleClient c) {
        if (c.getCharacter().getCarnivalParty() == null) {
            c.sendPacket(CWvsContext.enableActions());
            return;
        }
        final int tab = inPacket.readByte();
        final int num = inPacket.readInt();

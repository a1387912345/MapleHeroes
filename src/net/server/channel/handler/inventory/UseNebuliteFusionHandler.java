...
public class UseNebuliteFusionHandler extends MaplePacketHandler {
	...
	public void handlePacket(MaplePacketReader mpr, MapleClient c, MapleCharacter chr) {
        ...
        if (grade1 == -1 || grade2 == -1 || (highestRank == 3 && premiumQuantity != 2) || (highestRank == 2 && premiumQuantity != 1)
            ...
            c.sendPacket(CField.useNebuliteFusion(c.getCharacter().getID(), 0, false));
        ...
        c.sendPacket(CField.useNebuliteFusion(c.getCharacter().getID(), newId, true));
	}

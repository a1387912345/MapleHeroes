...
public class MagnifyGlassHandler extends MaplePacketHandler {
	...
	public void handlePacket(MaplePacketReader lea, MapleClient c, MapleCharacter chr) {
        ...
        if (eqq.getState() == 1 && (src == 0x7F && price != -1 && c.getCharacter().getMeso() >= price
            ...
            if (!insight && src != 0x7F) {
                c.sendPacket(InventoryPacket.scrolledItem(magnify, equipped ? MapleInventoryType.EQUIPPED : MapleInventoryType.EQUIP, toReveal, false, true, equipped));
